...
public class Breakout extends GraphicsProgram {
	...
	// This is a previously declared method which paints every pair of rows in
	// different colors
	...
	// method draws paddle
	private void paddle() {
		int x = WIDTH / 2 - PADDLE_WIDTH / 2; // sets the paddle in center
	...
	private void lost() {
		...
		if (turnCount == 0) {
			removeAll();
			result("GAME OVER :/"); // if player lose ball 3 times, "GAME OVER" message is put on canvas
		}
